...
bobs_private_key = keys.UmbralPrivateKey.gen_key()#input through database
bobs_public_key = bobs_private_key.get_pubkey()

#6
# Bob receives a capsule through a side channel (s3, ipfs, Google cloud, etc)
bob_capsule = capsule# input when shared
...
umbral_sample_api.py
Displaying umbral_sample_api.py.