...
cipherbyte = keys_dict['ciphertext'].encode('cp855')
print(cipherbyte)

bob_cleartext = pre.decrypt(ciphertext=cipherbyte, capsule=capsule, decrypting_key=keys_dict['receiverprivatekey'])

print(bob_cleartext)
path = "/home/anmolmiddha/Projects/coreshare/server/accept/input." + str(keys_dict['sharefilename'].split('.')[-1])
print(path)
